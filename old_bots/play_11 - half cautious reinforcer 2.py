...
# A Half Cautious Reinforcer that removes invasion targets after sending fleets to them.
cmd = "tcp.exe 72.44.46.68 995 iouri.11 -p victory half_cautious_reinforcer2.exe"
