...
# A Half Cautious Reinforcer 2 with simplified timeline calculations (removed
# advancing of the timeline start point between the turns), and feeders removed
# from the list of sources of attacks.
cmd = "tcp.exe 72.44.46.68 995 iouri.13 -p victory half_cautious_reinforcer4.exe"
...
def sleepAwhile(): # to prevent pairing up with same opp over and over
    duration = random.randrange(2,125) # 35 to 125 seconds
